...
for f in fotos_filtered:
    ...
    print('Обработано фото: {}/{}, {} %'.format(foto_counter, number_fotos,                                            int(percent*100)), end='\r')
    if finding_of_cat(f, data_dir=foto_dir) >= theshold_percentage:
